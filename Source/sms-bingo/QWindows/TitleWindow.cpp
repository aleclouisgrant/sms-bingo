	...
	: QMainWindow(parent)
{
	...
	m_middleWidget->setStyleSheet("background-color: rgba(0,0,0,0)");
	m_middleWidget->setWindowFlags(Qt::FramelessWindowHint);
	m_middleWidget->setAttribute(Qt::WA_NoSystemBackground);
	m_middleWidget->setAttribute(Qt::WA_TranslucentBackground);
	m_middleWidget->setAttribute(Qt::WA_TransparentForMouseEvents);
